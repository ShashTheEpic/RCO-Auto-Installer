...
set RCO_url=https://raw.githubusercontent.com/L8X/Roblox-Client-Optimizer/main/assets/ClientAppSettings.json REM https://roblox-client-optimizer.simulhost.com/ClientAppSettings.json is an alternative link to use
